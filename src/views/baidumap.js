window.TILE_VERSION = {
  ditu: {
    normal: { version: "088", updateDate: "20200407" },
    satellite: { version: "009", updateDate: "20200407" },
    normalTraffic: { version: "081", updateDate: "20200407" },
    satelliteTraffic: { version: "083", updateDate: "20200407" },
    mapJS: { version: "104", updateDate: "20200407" },
    satelliteStreet: { version: "083", updateDate: "20200407" },
    earthVector: { version: "001", updateDate: "20200407" },
  },
  webapp: {
    high_normal: { version: "001", updateDate: "20200407" },
    lower_normal: { version: "002", updateDate: "20200407" },
  },
  api_for_mobile: {
    vector: { version: "002", updateDate: "20200407" },
    vectorIcon: { version: "002", updateDate: "20200407" },
  },
};
window.BMAP_AUTHENTIC_KEY = "GCOECKufEecKgGt63f1oroO4jxResTt1";
(function() {
  function ca(a) {
    throw a;
  }
  ...
  x.K.ha = function(a) {
    ...
    var e = { left: 0, top: 0 },
      f;
    if (a == (c.la && !c.GE ? b.body : b.documentElement)) return e;
    if (a.getBoundingClientRect) {
      ...
      if (c.opera > 0 || (c.AM > 0 && d(a, "position") == "absolute"))
  ...
  x.iL = (function() {
    ...
    a.prototype = {
      ...
      move: function(a) {
        ...
        if (
          10 <
            Math.abs((this.Ek ? a.touches[0].clientX : a.clientX) - this.qu) ||
          10 < Math.abs(c - this.ru)
        )
          this.uh = o;
      },
      end: function(a) {
  ...
  z.lV =
    ...
    function() {
      z.version &&
        z.version >= 1.5 &&
        pa(z.oc + "?qt=verify&ak=" + qa, function(a) {
          if (a && a.error !== 0) {
  ...
  function Ka(a, b) {
    if ((a = x.$(a))) {
      ...
      window.GCJMAP = this;
      c.B.ze && (this.uY(c.B.ze.controls), this.oM(c.B.ze.geotableId));
      ...
      c.fv();
      c.R = { Ic: q, kc: 0, Ap: 0, FM: 0, D3: 0, oC: q, oF: -1, Re: [] };
      c.platform.style.cursor = c.B.Xb;
      for (e = 0; e < z.Nr.length; e++) z.Nr[e](c);
      c.R.oF = e;
      c.ca();
      I.load("map", function() {
        c.xb();
  ...
  x.extend(Ka.prototype, {
    ...
    mk: function(a, b, c, d) {
      var e = this.oa().yc(this.ga()),
        f = this.Ld,
        g = o;
      c && N.BE(c) && ((this.re = new H(c.lng, c.lat)), (g = q));
      if ((c = c && d ? f.Hk(c, this.Sb) : this.dc))
        if (
          ((this.dc = new H(c.lng + a * e, c.lat - b * e)),
    ...
    Hg: function(a, b) {
      if (
        ...
        var c;
        b
          ? (c = new H(Ya(cp, me).lng, Ya(b, me).lat))
          : this.lh() && (c = this.lh().ha());
        c &&
          ((c = this.Cc(c, this.Mc)),
          this.mk(
            this.width / 2 - c.x,
    ...
    Wf: function(a) {
      var b = this;
      if (a instanceof N || a instanceof H)
        (a = new H(Ya(a, b).lng, Ya(a, b).lat)), b.zi(a, { noAnimation: o });
      else if (ab(a))
        if (b.Hb === Pa) {
          var c = F.sC[a];
          c && ((pt = c.m), b.Wf(pt));
          ...
          d.KF(function(c) {
            0 === d.Fm() &&
              2 === d.Ga.result.type &&
              (b.Wf(c.Ck(0).point), Pa.yk(a) && b.EF(a));
          });
    ...
    Ed: function(a, b) {
      "[object Undefined]" !== Object.prototype.toString.call(b) &&
        (b = parseInt(b));
      z.Jn("cus.fire", "time", { z_loadscripttime: sa - ra });
      var c = this;
      if (ab(a))
        if (c.Hb === Pa) {
          var d = F.sC[a];
    ...
    Vo: function() {
      this.B.Vo = o;
      this.Rn || ((this.Rn = new db({ pL: o })), this.$g(this.Rn));
    },
    wW: function() {
      this.B.Vo = q;
      this.Rn && (this.Bh(this.Rn), (this.Rn = p), delete this.Rn);
    },
    tb: function() {
      return this.Cs && this.Cs instanceof L
        ? new L(this.Cs.width, this.Cs.height)
    ...
    Kp: function(a, b) {
      ...
      if (a && (a instanceof N || a instanceof H))
        return (a = Ya(a, this)), this.Ld.Kp(a, b, this.dc, this.tb(), this.Sb);
    },
    Rb: function(a, b) {
      b = b || this.ga();
    ...
    Z3: function(a, b) {
      ...
      this.Hb === Pa &&
        c &&
        ((a.x += this.offsetX), (a.y += this.offsetY), fb.CK(a, this, b));
    },
    Id: function(a) {
      if (!this.$x()) return new gb();
      var b = a || {},
        a = b.margins || [0, 0, 0, 0],
        c = b.zoom || p,
    ...
    lt: function(a, b) {
      ...
      if (
        !a ||
        (!a instanceof gb && 0 === a.length) ||
        (a instanceof gb && a.Cj())
      )
        return c;
      var d = [];
      a instanceof gb
        ? (d.push(Ya(a.pf(), this)), d.push(Ya(a.xe(), this)))
        : (d = a.slice(0));
      ...
      return { center: eb(c, this), zoom: e };
    },
    Eh: function(a, b) {
      var c;
    ...
    oa: v("Hb"),
    Hz: function() {
      for (var a = this.R.oF; a < z.Nr.length; a++) z.Nr[a](this);
      this.R.oF = a;
    },
    EF: function(a) {
      this.Sb = Pa.yk(a);
    ...
    Cw: function(a, b) {
      ...
      a.tag = b;
      a instanceof jb && ((this.Th[b][a.ba] = a), a.ra(this));
      var c = this;
      I.load(
        "hotspot",
        function() {
    ...
    uY: function(a) {
      ...
      var b = this,
        c;
      for (c in this.controls) b.QN(b.controls[c]);
      a = a || [];
    ...
    oM: function(a) {
      a
        ? (this.As && this.As.Bf === a) ||
          (this.Bh(this.As),
          (this.As = new ob({ geotableId: a })),
          this.$g(this.As))
        : this.Bh(this.As);
    },
    Wb: function() {
    ...
    getCurrentCity: function() {
      return { name: this.bh, code: this.ks };
    },
    Cm: function() {
      this.P.jo();
      return this.P;
  ...
  z.l0 = {
    "0": { proto: "http://", domain: z.oY },
    1: { proto: "https://", domain: z.iM },
    2: { proto: "https://", domain: z.iM },
  };
  ...
  function tb(a) {
    var b = { duration: 1e3, Hc: 30, Ro: 0, hc: ub.NM, Nt: t() };
    this.Zf = [];
  ...
  tb.prototype.stop = function(a) {
    ...
    for (var b = 0; b < this.Zf.length; b++)
      this.Zf[b].stop(), (this.Zf[b] = p);
    this.Zf.length = 0;
    this.ds && (clearTimeout(this.ds), (this.ds = p));
    this.k.Nt(this.Ly);
    a && ((this.kA = this.Wu), wb(this));
  };
  ...
  var F = {
    ...
    nP: 73,
    sC: {
      北京: { Cy: "bj", m: new H(116.403874, 39.914889) },
      上海: { Cy: "sh", m: new H(121.487899, 31.249162) },
      深圳: { Cy: "sz", m: new H(114.025974, 22.546054) },
      广州: { Cy: "gz", m: new H(113.30765, 23.120049) },
    },
  ...
  x.da.Te
    ? (x.extend(F, {
      ...
      x.platform.BM && (F.fontFamily = "arial,simsun,sans-serif"))
    : x.da.Rw || x.da.wF
    ? x.extend(F, {
  ...
  z.qq = { CG: "#83a1ff", tq: "#808080" };
  function Pb(a, b, c) {
    b.Um || ((b.Um = []), (b.handle = {}));
    b.Um.push({ filter: c, wm: a });
    b.addEventListener ||
  ...
  void (function(a, b, c) {
    void (function(a, b, c) {
      ...
      function w(a) {
        this.name = a;
        this.Us = { protocolParameter: { postUrl: p, protocolParameter: p } };
        this.iK = [];
        this.alog = O;
      }
      function y(a) {
      ...
      if (!B || !B.Qo) {
        ...
        w.prototype.send = function(a, b) {
          var c = u({ ts: i().toString(36), t: a, sid: C }, this.Us);
      ...
      if (s && s.Ch && k() < s.Ch) {
        var A = ["Moz", "O", "ms", "Webkit"],
          ...
          Ki = function() {
            return (
              !!b.createElementNS &&
              !!b.createElementNS("http://www.w3.org/2000/svg", "svg").Z1
            );
          },
          Li = function() {
            return !!a.V0;
        ...
        u.M("commit", function() {
          ...
          var a = setInterval(function() {
            if (
              "WebP-lossy" in Rb.ni &&
              "WebP-lossless" in Rb.ni &&
              "WebP-alpha" in Rb.ni &&
              "WebP-animation" in Rb.ni
            ) {
              for (var b in Rb.ni) Rb.ni[b] = Rb.ni[b] ? "y" : "n";
              u.send("feature", Rb.ni);
              clearInterval(a);
            }
          }, 500);
        });
        c.alog("feature.create", { k2: 4, d4: i, page: g, vb: "18" });
  ...
  function qc(a) {
    ...
    return { lng: a * Math.cos(b) + hc, lat: a * Math.sin(b) + ic };
  }
  function rc(a) {
    var b = sc,
      c = {},
      ...
      k = m.lng,
      m = m.lat;
    if (1.0e-6 >= wc(k, m, g, i)) return (c.lng = d), (c.lat = e), c;
    for (;;) {
      k = d - f;
      m = e + f;
      s = d - f;
  ...
  xc.prototype.contains = function(a) {
    return a.lng > this.vg.lng &&
      ...
      a.lat < this.Dg.lat
      ? lc
      : Math.abs(a.lng - this.vg.lng) < mc ||
        Math.abs(a.lng - this.Dg.lng) < mc ||
        Math.abs(a.lat - this.vg.lat) < mc ||
        Math.abs(a.y - this.Dg.lat) > mc
      ? 2
      : kc;
  };
  ...
  function sc(a) {
    ...
    if ((0 === f ? kc : lc) === kc) {
      for (f = 0; f < Zb; ++f)
        if (
          ((d = new yc($b[f], ac[f], $b[(f + 1) % Zb], ac[(f + 1) % Zb])),
          ...
          g = m - k;
          var n = i - l;
          !(Math.abs(g - 0) > mc) && !(Math.abs(n - 0) > mc)
            ? (g = d.nu)
            : ((i = l * k - i * m),
              (k = n * a.lng - g * a.lat),
              (l = g * g - n * n),
          ...
          g.lng <= k && g.lng >= n && g.lng <= l && g.lat >= i
            ? ((d = a.lat * gc),
              ...
              -1 > d ? (d = -1) : 1 < d && (d = 1),
              (d = Math.acos(d) * nc))
            : ((g = zc(a, d.nu)), (d = zc(a, d.sx)), (d = g < d ? g : d));
          d < c && (c = d);
        }
      c < jc && (b = (jc - c) / jc);
    } else b = 1;
  ...
  x.object.extend(I, {
    ...
    g4: {},
    wG: { nQ: z.ma + "getmodules?v=2.0&t=20140707", PU: 5e3 },
    PC: q,
    Rd: { Al: {}, Ln: [], ew: [] },
    load: function(a, b, c) {
      var d = this.kb(a);
    ...
    zK: function(a) {
      if (a && this.FL()[a])
        for (var a = this.FL()[a], b = 0; b < a.length; b++)
          this.zK(a[b]), this.Rd.Al[a[b]] || this.NN(a[b]);
    },
    NN: function(a) {
      for (var b = 0; b < this.Rd.Ln.length; b++)
        if (this.Rd.Ln[b] == a) return;
      this.Rd.Ln.push(a);
    },
    OZ: function(a, b) {
      var c = this.kb(a);
      ...
      c.Cd = this.Kj.lq;
      for (var e = 0, f = c.av.length; e < f; e++) c.av[e]();
      c.av.length = 0;
    },
    tK: function(a, b) {
      var c = this;
      c.timeout = setTimeout(function() {
        c.Rd.Al[a].Cd != c.Kj.lq
  ...
  x.extend(Dc.prototype, {
    ...
    Ie: function(a) {
      !this.C &&
        this.initialize && Za(this.initialize) &&
  ...
  function lb(a) {
    Dc.call(this);
    a = a || {};
    this.k = { Cg: q, color: "black", dd: "metric", Aa: a.offset };
    this.defaultAnchor = Gc;
  ...
  function Lc(a) {
    ...
    this.Vi = q;
    this.jw = p;
    this.QI = new Mc({ of: "api" });
    this.RI = new Nc(p, { of: "api" });
    this.defaultAnchor = Fc;
    this.defaultOffset = new L(10, 10);
    this.qc(a.anchor);
    this.Ee();
  ...
  x.object.extend(Oc.prototype, {
    ...
    rF: function(a) {
      if (this.Ge[a]) {
        for (var b = 0, c = this.ya.length; b < c; b++)
          this.ya[b] &&
            "divider" == this.ya[b].Lb && this.ya[b].Sj == a &&
  ...
  x.object.extend(gb.prototype, {
    ...
    ab: function(a) {
      return !(a instanceof gb) || this.Cj()
        ? q
    ...
    pf: v("Dl"),
    YV: function(a) {
      return !(a instanceof gb) || this.Cj() || a.Cj()
        ? q
    ...
    qs: function(a) {
      return !(a instanceof N || a instanceof H) || this.Cj()
        ? q
        : a.lng >= this.Ne &&
            a.lng <= this.Je &&
            a.lat >= this.Zd &&
  ...
  U(Vc.prototype, { translate: Vc.prototype.translate });
  function T() {}
  T.prototype = new Sc();
  x.extend(T, {
    AP: 6370996.81,
  ...
  z.Xe(function(a) {
    ...
    a.addEventListener("clearoverlays", function() {
      this.Xc();
      for (var a in b.wa) b.wa[a].z.rj && (b.wa[a].remove(), delete b.wa[a]);
      a = 0;
  ...
  Yc.dF = [0.09, 0.005, 1.0e-4, 1.0e-5];
  x.extend(Yc.prototype, {
    ...
    qn: function(a, b) {
      b &&
        this.ia[a] &&
        ((this.gf.length = 0), (this.ia[a] = new H(b.lng, b.lat)), this.Jh());
    },
  ...
  x.extend(Zc.prototype, {
    Mj: function() {
      ...
      "none" != a.borderColor &&
        c.push("border:" + a.gy + "px " + a.QY + " " + a.LM + ";");
      c.push(
    ...
    draw: function() {
      ...
      this.z.Aa = new L(
        -Math.round(this.z.width / 2) - Math.round(this.z.gy),
        -Math.round(this.z.height / 2) - Math.round(this.z.gy)
      );
  ...
  function bd(a, b, c, d) {
    a &&
      ...
      (this.XI = !!(c.indexOf("%") + 1)),
      (this.repeat =
        c != j ? (this.XI ? parseFloat(c) / 100 : parseFloat(c)) : 0));
  }
  function cd(a, b) {
    x.lang.Da.call(this);
    this.content = a;
  ...
  x.extend(cd.prototype, {
    ...
    Va: ea(q),
    ha: function() {
      if (this.cb && this.cb.ha) return this.cb.ha();
    },
    Qf: function() {
      return this.z.Aa;
    },
  ...
  Ka.prototype.Mb = function(a, b) {
    if (a instanceof cd && (b instanceof N || b instanceof H)) {
      ...
      c.Tm
        ? c.Tm.ta(b)
        : ((c.Tm = new V(b, {
            icon: new $c(F.qa + "blank.gif", { width: 1, height: 1 }),
            offset: new L(0, 0),
            clickable: q,
          })),
          (c.Tm.TR = 1));
  ...
  x.extend(id.prototype, {
    initialize: function(a) {
      this.uB && this.uB.push({ method: "initialize", arguments: arguments });
    },
  ...
  x.extend(V.prototype, {
    Vb: function(a) {
      if (a instanceof $c || a instanceof ad) this.z.zj = a;
    },
    ep: function() {
      return this.z.zj;
    },
    ...
    bo: v("point"),
    ha: function() {
      return this.point instanceof N || this.point instanceof H
        ? this.map
  ...
  x.extend(ld.prototype, {
    ...
    qn: function(a, b) {
      this.zo[a] &&
        ((this.zo[a] = new N(b.lng, b.lat)),
        (this.ia[a] = new N(b.lng, b.lat)),
        0 == a &&
          !this.ia[0].ab(this.ia[this.ia.length - 1]) &&
          (this.ia[this.ia.length - 1] = new N(b.lng, b.lat)),
        this.Jh());
    },
    ve: function() {
      var a = this.zo;
  ...
  x.extend(sd.prototype, {
    ...
    zf: function() {
      ...
      var a = this;
      this.AE &&
        (this.map.dispatchEvent(new M("onfirsttileloaded")), (this.AE = q));
      0 == this.vh &&
        (this.Qi && (clearTimeout(this.Qi), (this.Qi = p)),
    ...
    Im: function(a, b, c) {
      ...
      for (d = a.childNodes.length; l < d; l++)
        (w = a.childNodes[l]), (w.rr = q), this.Oe.push(w);
      if ((l = this.Ym)) for (var A in l) delete l[A];
      else this.Ym = {};
      ...
      for (d = this.Oe.length; l < d; l++)
        (n = this.Oe[l]), n.rr || this.Pe.push(n);
      this.yn = [];
          ...
          if (a.vh == 0) {
            ...
            if (ua) {
              if (ra && sa && ta) {
                ...
                z.Jn("cus.fire", "time", { z_imgfirstloaded: b - ta });
              }
              ua = q;
            }
          }
    ...
    Ux: function(a) {
      ...
      delete this.wg[a.name];
      a.loaded || (yd(b), ud(a), (a.Gb = p), (a.Vm = p));
    },
    Mw: function(a, b) {
      for (
        ...
        (a -= d), (c -= this.aB);
      for (; a < f; ) (a += d), (c += this.aB);
      c = Math.round(c / Math.pow(2, 18 - b));
      return { offsetX: c, ns: a };
    },
    FV: function(a) {
    ...
    GV: function(a, b) {
      for (
        var c = 256 * Math.pow(2, 18 - b),
          d = Math.floor(this.yI / c),
          e = Math.floor(this.zI / c),
          c = Math.floor(this.aB / c),
          f = [],
          g = 0;
        g < a.length;
        g++
    ...
    Uf: function(a) {
      ...
      if (b.map.oa() == Pa)
        I.load(
          ...
          function() {
            b.map.Sb ||
              ((b.map.Sb = Pa.yk(b.map.bh)), (b.map.Sw = Pa.BL(b.map.Sb)));
            b.CI();
          },
          o
        );
      else {
        if (a && a) for (var c in this.ij) delete this.ij[c];
        b.CI(a);
      }
    },
    CI: function(a) {
      ...
      for (var g = 0; g < c; g++) {
        ...
        if (!i.pI && !((i.yp && !this.map.Wb()) || (i.zM && this.map.Wb()))) {
          ...
          w = [];
          for (d.YB = []; n < u; n++)
            for (y = l; y < e; y++) w.push([n, y]), d.YB.push({ x: n, y: y });
          ...
          m = w.length;
          this.vh += m;
          for (n = 0; n < m; n++) this.C_([w[n][0], w[n][1], f], s, i, a);
        }
      }
    },
    $g: function(a) {
      var b = this,
        c = a.target,
        a = b.map.Wb();
      if (c instanceof db) a && !c.Om && (c.ra(this.map, this.md), (c.Om = o));
      else if ((c.Hh && this.map.$g(c.Hh), c.yp)) {
    ...
    Bh: function(a) {
      var a = a.target,
        b = this.map.Wb();
      if (a instanceof db) b && a.Om && (a.remove(), (a.Om = q));
      else {
    ...
    Eg: function() {
      for (var a = this.Sm, b = 0, c = a.length; b < c; b++) a[b].remove();
      delete this.Pb;
      this.Sm = [];
      this.ij = this.wg = {};
      this.Xx();
    ...
    bu: function(a) {
      var b = this.map.oa();
      if (!this.map.Wb() && (a ? (this.map.B.K_ = a) : (a = this.map.B.K_), a))
        for (
          var c = p,
            c =
              "2" == z.dz
  ...
  function ud(a) {
    for (var b = 0; b < a.cv.length; b++) a.cv[b]();
    a.cv.length = 0;
  }
  function yd(a) {
    if (a) {
      ...
      if (b) {
        d = b.length;
        for (c = 0; c < d; c += 1)
          (e = b[c].name), "unknown" !== typeof a[e] && Za(a[e]) && (a[e] = p);
      }
      if ((b = a.children)) {
        d = b.length;
  ...
  x.extend(td.prototype, {
    ...
    getTilesUrl: function(a, b) {
      ...
      var d = "";
      this.wh.tileUrlTemplate &&
        ((d = this.wh.tileUrlTemplate.replace(/\{X\}/, c)),
        (d = d.replace(/\{Y\}/, a.y)),
        (d = d.replace(/\{Z\}/, b)));
      return d;
    },
  ...
  function ob(a, b) {
    ...
    d && ((this.Hh = new Ad(a, b)), (this.Hh.WF = this));
    Ib(a) ? (b = a || {}) : ((c.Wn = a), (b = b || {}));
  ...
  ob.prototype.getTilesUrl = function(a, b) {
    var c = a.x,
      ...
      c =
        ...
        "&format=" +
        e.S_;
    e.eG || ((e = (1e5 * Math.random()).toFixed(0)), (c += "&timeStamp=" + e));
    this.Bf
      ? (c += "&geotable_id=" + this.Bf)
      : this.Wn && (c += "&databox_id=" + this.Wn);
    return c;
  };
  ...
  Ld.getTilesUrl = function(a, b) {
    ...
    return (url =
      this.FO[Math.abs(c + d) % this.FO.length] +
      this.map.Sb +
      "/" +
      this.map.Sw +
      "/3/lv" +
  ...
  Pa.yk = function(a) {
    ...
    var b = F.sC,
      c;
    for (c in b) if (-1 < a.search(c)) return b[c].Cy;
    return "";
  };
  Pa.BL = function(a) {
  ...
  function ce(a, b, c) {
    ...
    if (a) {
      ...
      this.pK = b;
      this.update = o;
      a = { page: 1, Ze: 100, Kd: 100, Vf: 4, hK: "pg", update: o };
      c || (c = a);
  ...
  x.extend(ce.prototype, {
    ...
    toPage: function(a) {
      a = a ? a : 1;
      "function" == typeof this.pK && (this.pK(a), (this.page = a));
      this.update && this.va();
    },
  });
  function cb(a, b) {
  ...
  var qe = pe.prototype;
  U(qe, { getPoint: qe.Em, getLocation: qe.Am });
  ...
  function Oa(a, b) {
    ...
    this.k.cT !== o &&
      (this.jo(), z.Jn("cus.fire", "count", "z_loadpanoramacount"));
    this.UT(this.C);
  ...
  x.extend(Oa.prototype, {
    ...
    IB: function() {
      if (this.D)
        for (var a = this.D.Jx(), b = 0; b < a.length; b++)
          (a[b] instanceof V || a[b] instanceof dd) &&
            a[b].point &&
            this.wa.push(a[b]);
    },
    HF: da("D"),
    ...
    lr: function() {
      return Va() && !G() && "javascript" !== this.k.panoramaRenderer
        ? "flashRender"
        : !G() && Nb()
        ? "cvsRender"
        : "cssRender";
  ...
  x.extend(Ae.prototype, {
    ...
    ao: function() {
      var a = 0,
        ...
        c;
      this.P &&
        ((b = this.P.ha()), (c = this.ha()) && !c.ab(b) && (a = T.dp(b, c)));
      return a;
    },
    U: function() {
      ca("hide\u65b9\u6cd5\u672a\u5b9e\u73b0");
  ...
  z.$m(function(a) {
    "flashRender" !== a.lr() && new Nc(a, { of: "api" });
  });
    ...
    ca: function() {
      function a(a) {
        if (a) {
          ...
          (b.Ya = b.xl), (b.Kb = b.yl), b.dispatchEvent(new M("onnoresult"));
      }
      var b = this.P,
        c = this;
  ...
  x.extend(Oe, {
    AW: function(a, b, c) {
      ...
      b = { data: b };
      "position_changed" == a &&
        (b.data = Oe.Wd.Ej(new S(b.data.mercatorX, b.data.mercatorY)));
      c.dispatchEvent(new M("on" + a), b);
    },
  });
  var Pe = Oe;
  U(Pe, { dispatchFlashEvent: Pe.AW });
  var Qe = { EP: 50 };
  Qe.Qu = z.sg("pano")[0];
  Qe.Mu = { width: 220, height: 60 };
  x.extend(Qe, {
    vp: function(a, b, c, d) {
      if (!b || !c || !c.lngLat || !c.panoInstance) d();
      else {
        this.oo === j && (this.oo = new Nc(p, { of: "api" }));
        var e = this;
        this.oo.qC(b, function(b) {
          b
            ? e.oo.uj(c.lngLat, Qe.EP, function(b) {
                if (b && b.id) {
                  var f = b.id,
                    k = b.xh,
                    b = b.yh,
  ...
  function wf(a, b) {
    ...
    c.options.$k
      ? (c.Nb.style[af] = "translate(" + c.x + "px," + c.y + "px)" + vf)
      : (c.Nb.style.cssText +=
    ...
    this.options.Px &&
      (Event.prototype.stopImmediatePropagation ||
        ((document.body.removeEventListener = function(a, b, c) {
          ...
          a === "click"
            ? d.call(document.body, a, b.eM || b, c)
  ...
  wf.prototype = {
    ...
    IQ: function() {
      !this.uh &&
        !this.cl &&
          !(
            this.dm ||
            (this.My == this.Nb.offsetWidth * this.scale &&
    ...
    Tv: function(a) {
      ...
      this[a + "Scrollbar"]
        ? (this[a + "ScrollbarWrapper"] ||
            ...
            this.options.yF
              ? (b.className = this.options.yF + a.toUpperCase())
              : (b.style.cssText =
    ...
    CB: function(a, b) {
      ...
      this[a + "Scrollbar"] &&
        ...
        0 > c
          ? (this.options.ED ||
              ((c = this[a + "ScrollbarIndicatorSize"] + Se.round(3 * c)),
              8 > c && (c = 8),
          ...
          : c > this[a + "ScrollbarMaxScroll"] &&
            (this.options.ED
              ...
              : ((c =
                  ...
                  Se.round(3 * (c - this[a + "ScrollbarMaxScroll"]))),
                8 > c && (c = 8),
                (this[a + "ScrollbarIndicator"].style[
                  "h" == a ? "width" : "height"
                ] = c + "px"),
        ...
        (this[a + "ScrollbarWrapper"].style.opacity =
          b && this.options.Tx ? "0" : "1"),
        (this[a + "ScrollbarIndicator"].style[af] =
          "translate(" + ("h" == a ? c + "px,0)" : "0," + c + "px)") + vf));
    },
    TQ: function(a) {
      if (a.PR === o) return (this.$B = a.target), (this.tx = Date.now()), o;
      if (this.$B && this.tx) {
        if (600 < Date.now() - this.tx) return (this.tx = this.$B = p), o;
      } else {
    ...
    bw: function(a) {
      ...
      if (this.enabled) {
        ...
        this.options.zoom &&
          kf && 1 < a.touches.length &&
          ((d = Se.abs(a.touches[0].pageX - a.touches[1].pageX)),
          (c = Se.abs(a.touches[0].pageY - a.touches[1].pageY)),
          (this.Y_ = Se.sqrt(d * d + c * c)),
          (this.wy =
            Se.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.iG) / 2 -
            this.x),
          (this.xy =
            Se.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.jG) / 2 -
            this.y),
      ...
      if (this.options.zoom && kf && 1 < a.touches.length)
        ...
        (6 > this.vw && 6 > this.ww) ||
          (this.options.RE &&
            (this.vw > this.ww + 5
              ? ((f = this.y), (d = 0))
              : this.ww > this.vw + 5 && ((e = this.x), (c = 0))),
          (this.uh = o),
          this.Jr(e, f),
          (this.TC = 0 < c ? -1 : 0 > c ? 1 : 0),
          (this.UC = 0 < d ? -1 : 0 > d ? 1 : 0),
          300 < g - this.startTime &&
            ((this.startTime = g), (this.qu = this.x), (this.ru = this.y)),
      ...
      if (!(kf && 0 !== a.touches.length)) {
        ...
        if (b.cl)
          ...
          if (b.uh) {
            ...
            f.Ca || g.Ca
              ? ((c = Se.max(Se.max(f.time, g.time), 10)),
                b.options.mu &&
                  ((f = d - b.xw),
                  (g = e - b.yw),
                  Se.abs(f) < b.options.Wy && Se.abs(g) < b.options.Wy
                    ? b.scrollTo(b.xw, b.yw, 200)
                    : ((f = b.vJ(d, e)),
                      (d = f.x),
                      (e = f.y),
                      (c = Se.max(f.time, c)))),
                b.scrollTo(Se.round(d), Se.round(e), c))
              : b.options.mu
              ? ((f = d - b.xw),
                (g = e - b.yw),
                Se.abs(f) < b.options.Wy && Se.abs(g) < b.options.Wy
    ...
    qo: function(a) {
      ...
      if (b == this.x && c == this.y) {
        if (
          (this.uh &&
            ((this.uh = q), this.options.uy && this.options.uy.call(this)),
          this.ri &&
            this.options.Tx &&
            ("webkit" == Ue && (this.cM.style[ff] = "300ms"),
    ...
    SU: function(a) {
      a.target == this.Nb && (this.$d(sf), this.OB());
    },
    OB: function() {
      var a = this,
        b = a.x,
    ...
    BI: function(a, b, c, d, e) {
      ...
      return { Ca: f * (0 > a ? -1 : 1), time: Se.round(b / 6.0e-4) };
    },
    ek: function(a) {
      for (var b = -a.offsetLeft, c = -a.offsetTop; (a = a.offsetParent); )
        (b -= a.offsetLeft), (c -= a.offsetTop);
      a != this.Dn && ((b *= this.scale), (c *= this.scale));
      return { left: b, top: c };
    },
    vJ: function(a, b) {
      var c, d, e;
      ...
      a = this.Ve[e];
      d = (d = Se.abs(a - this.Ve[this.KC]))
        ? 500 * (Se.abs(this.x - a) / d)
        : 0;
      this.KC = e;
      e = this.vf.length - 1;
      for (c = 0; c < e; c++)
      ...
      b = this.vf[e];
      c = (c = Se.abs(b - this.vf[this.LC]))
        ? 500 * (Se.abs(this.y - b) / c)
        : 0;
      this.LC = e;
    ...
    refresh: function() {
      ...
      this.Bn =
        this.options.Bn &&
        ((!this.options.AV && !this.qp) || this.Sp > this.En);
      ...
      this.Tv("h");
      this.Tv("v");
      this.cl || ((this.Nb.style[cf] = "0"), this.qo(400));
    },
    scrollTo: function(a, b, c, d) {
      ...
      for (b = e.length; a < b; a++)
        e[a].CZ && ((e[a].x = this.x - e[a].x), (e[a].y = this.y - e[a].y)),
          this.Fj.push({ x: e[a].x, y: e[a].y, time: e[a].time || 0 });
      this.OB();
    },
    disable: function() {
      this.stop();
    ...
    zoom: function(a, b, c, d) {
      ...
      this.options.$k &&
        ...
        (this.Nb.style[af] =
          "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + vf),
        (this.cl = q));
    },
  };
  function $e(a) {
  ...
  function xf(a) {
    ...
    this.Ql = new Nc(p, { of: "api" });
    this.fk = [];
    this.P = p;
    this.eg = { height: this.k.imageHeight, width: this.k.imageHeight * yf };
  ...
  z.$m(function(a) {
    ...
    a.addEventListener("position_changed", function() {
      a.k.visible &&
        a.k.albumsControl === o &&
        (b ? b.Gy(a.Yb()) : ((b = new xf(a.k.albumsControlOptions)), b.ra(a)));
    });
  ...
  x.extend(xf.prototype, {
    ...
    ss: function() {
      ...
      this.jk = K("div", { class: "pano_photo_item_seleted" });
      this.jk.style.height = this.eg.height - 6 + "px";
      this.jk.style.width = this.eg.width - 6 + "px";
      this.qc(this.k.anchor);
    },
    ...
    Gy: function(a, b) {
      if (
        b ||
        !this.fk[this.Yc] ||
        !(this.fk[this.Yc].panoId == a && 3 !== this.fk[this.Yc].recoType)
      ) {
        var c = this,
          d = this.SH(a);
                ...
                (d = a[m].catlog),
                  ...
                  j !== d &&
                    ("" === d && j !== i
                      ...
                      : (b[zf[d]] || (b[zf[d]] = []), b[zf[d]].push(a[m])));
              for (var s in b)
                k
                  ? l.push({ data: s + "F", index: s })
                  : l.push({ data: Af[s], index: s });
              c.iH = b;
              c.Si = l;
              c.Ml(a);
    ...
    iW: function() {
      if (!this.Pi) {
        ...
        new wf(a, { Ko: q, my: o, ri: q, Gi: q, Bn: q, RE: o, Qw: o, Px: o });
    ...
    fW: function() {
      if (this.Pi) (a = this.AL(this.Si)), (this.HQ.innerHTML = a);
      else {
    ...
    gW: function() {
      if (this.Si && !(0 >= this.Si.length)) {
        ...
        this.Pi &&
          (this.Pi.style.left =
            parseInt(this.Pi.style.left, 10) + this.eg.width + 8 + "px");
        var b = this;
    ...
    Ml: function(a) {
      ...
      this.k.showCatalog &&
        (0 < this.Si.length
          ? (Va() ? this.fW() : this.iW(), (this.Pc.offsetLeft = 60))
          : (this.Ts &&
              (this.C.removeChild(this.Ts),
              (this.Ts = p),
              (this.Pc.fg.style.left = "0px")),
            this.Pi && (this.C.removeChild(this.Pi), (this.Pi = p)),
            (this.Pc.offsetLeft = 0)));
      var b = this.xX(a);
      Va() &&
        this.Si && 0 < this.Si.length && this.k.showExit && this.lA &&
      ...
      b < a - 2 * this.Pc.Ji - this.Pc.offsetLeft
        ? (this.C.style.width = b + this.Pc.offsetLeft + "px")
        : ((this.C.style.width =
            isNaN(Number(this.k.maxWidth)) === o
              ? this.k.maxWidth
              : this.k.maxWidth + "px"),
          b < this.C.offsetWidth - 2 * this.Pc.Ji - this.Pc.offsetLeft &&
            (this.C.style.width = b + this.Pc.offsetLeft + "px"));
      this.Pc.refresh();
    ...
    xX: function(a) {
      for (
        ...
        (b = a[k]),
          ...
          3 === recoType
            ? Va()
              ? ((this.lA = b), (this.SW = d), a.splice(k, 1), k--)
              : ((b =
                  '<a href="javascript:void(0);" class="pano_photo_item" data-index="' +
                  k +
                  '"><img style="width:' +
  ...
  Bf.prototype = {
    ...
    refresh: function() {
      ...
      this.fg &&
        (this.fg.children[0].style.marginTop = this.Pr.children[0].style.marginTop =
    ...
    scrollTo: function(a) {
      a =
        a < this.Wg.offsetLeft
          ? Math.ceil((a - this.Ji - this.mo) / this.Xr) * this.Xr +
            this.mo +
            this.Ji -
            8
          : Math.ceil((a - this.Ji) / this.Xr) * this.Xr + this.Ji;
  ...
  var Gf = T.prototype;
  U(Gf, { lngLatToPoint: Gf.ph, pointToLngLat: Gf.Ej });
  var Hf = ib.prototype;
  U(Hf, { lngLatToPoint: Hf.ph, pointToLngLat: Hf.Ej });
  var If = gb.prototype;
  U(If, {
    equals: If.ab,
    containsPoint: If.qs,
  ...
  var Jf = Wc.prototype;
  U(Jf, { isVisible: Jf.oh, show: Jf.show, hide: Jf.U });
  Wc.getZIndex = Wc.Jm;
  var Kf = hb.prototype;
  U(Kf, {
  ...
  var Rf = ld.prototype;
  U(Rf, { getPath: Rf.ve, setPath: Rf.le, setPositionAt: Rf.qn });
  var Sf = jb.prototype;
  U(Sf, {
    getPosition: Sf.ha,
    setPosition: Sf.ta,
  ...
  var Uf = kb.prototype;
  U(Uf, { getType: Uf.op, setType: Uf.tn });
  U(window, {
  ...
  var Vf = mb.prototype;
  U(Vf, { changeView: Vf.se, setSize: Vf.Ce, getSize: Vf.tb });
  var Wf = lb.prototype;
  U(Wf, { getUnit: Wf.dY, setUnit: Wf.MF });
  ...
  var Yf = td.prototype;
  U(Yf, { getMapType: Yf.oa, getCopyright: Yf.ym, isTransparentPng: Yf.Et });
  var Zf = Oc.prototype;
  U(Zf, { addItem: Zf.Dw, addSeparator: Zf.dC, removeSeparator: Zf.rF });
  var $f = Rc.prototype;
  U($f, { setText: $f.fu });
  var ag = X.prototype;
  U(ag, {
  ...
  var cg = ee.prototype;
  U(cg, { clearResults: cg.Qe });
  ge = fe.prototype;
  U(ge, { setPolicy: ge.eu, toString: ge.toString, setPageCapacity: ge.Xp });
  U(window, {
  ...
  var dg = oe.prototype;
  U(dg, { routeCall: dg.aO });
  U(window, { BMAP_HIGHLIGHT_STEP: 1, BMAP_HIGHLIGHT_ROUTE: 2 });
  U(window, { BMAP_ROUTE_TYPE_DRIVING: Rd, BMAP_ROUTE_TYPE_WALKING: Qd });
  U(window, {
